...
class Themeisle_Customizer_Notify {
	...
	public function setup_config() {
		...
		$this->recommended_actions_title = isset( $this->config['recommended_actions_title'] ) ? $this->config['recommended_actions_title'] : 'wp-real-estate';
		$this->recommended_plugins_title = isset( $this->config['recommended_plugins_title'] ) ? $this->config['recommended_plugins_title'] : 'wp-real-estate';
		$this->dismiss_button = isset( $this->config['dismiss_button'] ) ? $this->config['dismiss_button'] : 'wp-real-estate';
		...
		$install_button_label = isset( $this->config['install_button_label'] ) ? $this->config['install_button_label'] : 'wp-real-estate';
		$activate_button_label = isset( $this->config['activate_button_label'] ) ? $this->config['activate_button_label'] : 'wp-real-estate';
		$deactivate_button_label = isset( $this->config['deactivate_button_label'] ) ? $this->config['deactivate_button_label'] : 'wp-real-estate';
	...
	public function themeisle_customizer_notify_scripts_for_customizer() {
		...
		wp_localize_script(
			'ti-customizer-notify-customizer-js', 'tiCustomizerNotifyObject', array(
				...
				'base_path'                => admin_url(),
				'activating_string'        => __( 'Activating', 'wp-real-estate' ),
			)
		);
