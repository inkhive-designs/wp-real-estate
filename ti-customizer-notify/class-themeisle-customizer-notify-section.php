...
class Themeisle_Customizer_Notify_Section extends WP_Customize_Section {
	 ...
	 * @var    string
	 */
	public $recommended_actions = 'wp-real-estate';
	/**
	 * Recommended Plugins.
	 *
	 * @var string
	 */
	public $recommended_plugins = 'wp-real-estate';
	/**
	 * Total number of required actions.
	 *
	 * @var string
	 */
	public $total_actions = 'wp-real-estate';
	/**
	 * Plugin text.
	 *
	 * @var string
	 */
	public $plugin_text = 'wp-real-estate';
	/**
	 * Dismiss button.
	 *
	 * @var string
	 */
	public $dismiss_button = 'wp-real-estate';
	...
	public function json() {
		...
		foreach ( $ti_customizer_notify_recommended_actions as $key => $ti_customizer_notify_recommended_action ) {
			...
			if ( isset( $ti_customizer_notify_recommended_action['plugin_slug'] ) ) {
				...
				if ( $active['needs'] !== 'install' && $active['status'] ) {
					...
					$ti_customizer_notify_recommended_action['class'] = 'wp-real-estate';
				}
		...
		foreach ( $ti_customizer_notify_recommended_plugins as $slug => $plugin_opt ) {
			...
			if ( $active['needs'] !== 'install' && $active['status'] ) {
				...
				$ti_customizer_notify_recommended_plugin['class'] = 'wp-real-estate';
			}
